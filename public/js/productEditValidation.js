...
const expresiones = {
  ...
  productDescription: /^[a-zA-ZÀ-ÿ\s0-9]{20,50}$/, //  Letras y espacios, pueden llevar acentos, igual que productName
  productDescriptionLong: /^[a-zA-ZÀ-ÿ\s0-9]{10,40}$/, //  Letras y espacios, pueden llevar acentos, igual que productName pero mayor cantidad de carecteres.
