  ...
  switch (e.target.name) {
    case "productName":
      if (expresiones.productName.test(e.target.value)) {
        document.querySelector("#grupo__nombre .formulario__input-error");
        document
        ...
        document
          .getElementById("productName")
          .classList.remove("borde_correcto_activo")
    ...
    case "productDescription":
      if (expresiones.productDescription.test(e.target.value)) {
        document.querySelector("#grupo__descripcion .formulario__input-error");
        document
    ...
    case "productDescriptionLong":
      if (expresiones.productDescriptionLong.test(e.target.value)) {
        document.querySelector(
          "#grupo__descripcionLong .formulario__input-error"
        );
        document
    ...
    case "productStock":
      if (expresiones.productStock.test(e.target.value)) {
        document.querySelector("#grupo__productStock .formulario__input-error");
        document
        ...
        document.querySelector(
          "#grupo__productStock  .formulario__input-error"
        );
        document
          .getElementById("productStock")
          .classList.add("borde_incorrecto_activo");
    ...
    case "productFees":
      if (expresiones.productFees.test(e.target.value)) {
        document.querySelector("#grupo__productFees .formulario__input-error");
        document
